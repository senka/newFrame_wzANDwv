void makeOtherInputFile_ratio(){


  int const N_bins=15;

  TString out_fileName="signal_WV.root";
  ...
  for (int i=0;i<N_bins;i++){
	...
	binContents_lam_dk[i]->SetBinContent(binX,binY,yield/yield_SM);
	...
	double yield=yield_SM*(p0+p1*pt+p2*pt*pt+p3*pt*pt*pt+p4*pt*pt*pt*pt +p5*pt*pt*pt*pt*pt+p6*pt*pt*pt*pt*pt*pt);
	binContents_lam_dg[i]->SetBinContent(binX,binY,yield/yield_SM);
	...
	double yield=yield_SM*(p0+p1*pt+p2*pt*pt+p3*pt*pt*pt+p4*pt*pt*pt*pt +p5*pt*pt*pt*pt*pt+p6*pt*pt*pt*pt*pt*pt);
	binContents_dk_dg[i]->SetBinContent(binX,binY,yield/yield_SM);
	//	cout <<"(dg="<<dg<<" , l="<<l<<" )" << " pt mean: "<< pt<<" SM yield: "<<yield_SM<<" yield: "<<yield << endl;
      }
    }
